...
export const metadata: Metadata = {
  ...
  description:
    "I build mobile apps and web products end-to-end. Flutter, React Native, Next.js. 19+ apps shipped. Based in Bangalore.",
  keywords: ["app developer", "flutter developer", "react native", "next.js", "bangalore", "freelance", "full stack"],
  openGraph: {
    title: "Aditya R — Full-Stack App & Web Developer",
    description: "19+ production apps shipped. Flutter, React Native, Next.js. Based in Bangalore.",
    type: "website",
