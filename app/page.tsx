    ...
    <>
      <style>{`
        ...
        @media(max-width:1024px){
          ...
          .hero-3d{height:400px!important;margin-top:20px!important}
          ...
          <div className="sec-pad" ref={statsRef} style={{ maxWidth: 1440, margin: "0 auto", padding: "120px 40px" }}>
            <div style={{ marginBottom: 72 }}>
              ...
              <motion.h2 initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}
                className="sec-title" style={{ fontFamily: D, fontWeight: 800, fontSize: "clamp(36px, 5vw, 64px)", letterSpacing: "-0.04em", color: "#fff", lineHeight: 1, marginBottom: 16, maxWidth: 900 }}>
        ...
        <section id="expertise" style={{ borderTop: "1px solid var(--border)" }}>
          <div className="sec-pad" style={{ maxWidth: 1440, margin: "0 auto", padding: "120px 40px" }}>
            <div style={{ marginBottom: 72 }}>
              ...
              <h2 className="sec-title" style={{ fontFamily: D, fontWeight: 800, fontSize: "clamp(36px, 5vw, 64px)", letterSpacing: "-0.04em", color: "#fff", lineHeight: 1, maxWidth: 900 }}>
        ...
        <section style={{ borderTop: "1px solid var(--border)" }}>
          <div className="sec-pad" style={{ maxWidth: 1440, margin: "0 auto", padding: "120px 40px" }}>
            <div style={{ marginBottom: 72 }}>
              ...
              <h2 className="sec-title" style={{ fontFamily: D, fontWeight: 800, fontSize: "clamp(36px, 5vw, 64px)", letterSpacing: "-0.04em", color: "#fff", lineHeight: 1 }}>
        ...
        <section id="services" style={{ borderTop: "1px solid var(--border)" }}>
          <div className="sec-pad" style={{ maxWidth: 1440, margin: "0 auto", padding: "120px 40px" }}>
            <div style={{ marginBottom: 72 }}>
              ...
              <h2 className="sec-title" style={{ fontFamily: D, fontWeight: 800, fontSize: "clamp(36px, 5vw, 64px)", letterSpacing: "-0.04em", color: "#fff", lineHeight: 1, marginBottom: 16 }}>
